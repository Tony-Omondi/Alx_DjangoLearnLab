...
ALLOWED_HOSTS = ['*']  # In production, specify exact hosts, e.g., ['yourapp.herokuapp.com']
...
DATABASES = {
    'default': {
        ...
        'HOST': 'HOST',                             # → database host (e.g., 'localhost' or a remote IP/domain)
        'PORT': '5432',                             # → e.g., 5432 for PostgreSQL, 3306 for MySQL
    }
}
